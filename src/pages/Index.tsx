...
import { ArrowDown, ArrowRight, Users, GraduationCap, Building2, Sparkles, Trophy, School, Palette, Lightbulb, Layers, Telescope } from "lucide-react";
          ...
          <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 py-14 md:py-20">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              <div>
                ...
                <h2 className="text-[26px] md:text-[34px] font-semibold tracking-tight leading-tight">
                  Üks otsustusvoog lõpuni
                </h2>
                <p className="mt-2 text-[15px] text-foreground/70 max-w-xl">
            ...
            <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                ...
                return (
                  <li
                    key={s.n}
                    className="relative rounded-2xl border border-border bg-card p-5 hover:shadow-card hover:border-primary/40 transition-smooth"
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div className={`size-9 rounded-lg ${tone} flex items-center justify-center text-[13px] font-bold tabular`}>
                        {s.n}
                      </div>
                      <h3 className="text-[15.5px] font-semibold tracking-tight">{s.title}</h3>
                    </div>
